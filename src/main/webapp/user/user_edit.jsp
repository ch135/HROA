				...
				<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
					<form id="form_user" class="am-form am-form-horizontal" action="/HROA/ShUser/saveShUser.html">
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="realname" type="text" id="name" value="${user.realname }" placeholder="姓名 / Name" required>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<label class="am-radio-inline"> <input type="radio" value="男"  ${user.sex=='男'?'checked':'' } name="sex" required>男</label> 
								<label class="am-radio-inline"> <input type="radio" value="女" ${user.sex=='女'?'checked':'' }    name="sex" required>女</label>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input type="tel" name="telephone" value="${user.telephone }" id="user-phone" placeholder="联系电话 / Telephone" required>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="idcard" type="text" value="${user.idcard }"  id="idcard" placeholder="身份证 / IdCard" required>
							</div>
						</div>
		              ...
		              <label for="user-email" class="am-u-sm-3 am-form-label">地址</label>
						...
						<div class="am-form-group">
							<div class="am-u-sm-9 am-u-sm-push-3">
								<button id="addUser" type="button" class="am-btn am-btn-primary am-btn-block">修改用户信息</button>
							</div>
						</div>
...
<![endif]-->
	...
	<script type="text/javascript">
		...
		window.onload=function(){
		 $("#s_province").find("option[value='${user.province}']").attr("selected",true);
		 $("#s_province").trigger("change");
		 $("#s_city").find("option[value='${user.city}']").attr("selected",true);
		 $("#s_city").trigger("change");
		 $("#s_county").find("option[value='${user.region}']").attr("selected",true);
