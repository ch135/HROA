		...
		<div class="admin-content-body">
			<div class="am-cf am-padding am-padding-bottom-0">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">企业资料</strong> / <small>Personal
						information</small>
				</div>
			</div>
			...
			<div class="am-g">
				...
				<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
					<form id="doc-vld-msg" class="am-form am-form-horizontal"
						action="/HROA/JobRecord/add.html">
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">企业名称</label>
							<div class="am-u-sm-9">
								<input name="name" type="text" id="name" placeholder="企业名称"
									required>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="linkMan" type="text" id="user-weibo"
									placeholder="企业联系人 " required>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="linkPhone" type="text" id="user-weibo"
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="developMan" type="text" id="name"
									placeholder="开发人" required>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="developLink" type="number" id="name"
									placeholder="开发人电话" required>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="factoryMan" type="text" id="name"
									placeholder="驻厂管理" required>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="factoryPhone" type="tel" id="name"
									placeholder="驻厂管理电话" required>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="job" type="text" id="name" placeholder="工作岗位"
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="details" type="text" id="name"
									placeholder="具体地址 / details" required>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="number" type="number" id="name"
									placeholder="招聘人数" required>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="produce" type="text" id="produce"
									placeholder="主要生产产品  ">
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="url" type="text" id="name" placeholder="网址">
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<select id="doc-select-1" name="type">
									...
									<option value="0" ${type=='0'?'selected':'' }>小时工</option>
								</select>
							</div>
						</div>
		            ...
		            <div class="am-u-sm-9">
		            	<select  id="doc-select-1" name="classify">
							...
							<option value="假期工" >假期工</option>
							<option value="长期工" >长期工</option>
						...
						<div class="am-u-sm-9">
							<input name="salary" type="number" id="name"
								placeholder="基本工资"  >
						</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="moreSalary" type="number" id="name"
									placeholder="加班工资" >
							</div>
						</div>
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
							    <textarea name="describes" class="" rows="4" id="doc-ta-1"></textarea>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<label class="am-radio-inline"> <input type="radio"
									value="坐班" name="workType"> 坐班
								</label> <label class="am-radio-inline"> <input type="radio"
									name="workType" value="站班" > 站班</label>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<label class="am-radio-inline"> <input
									type="radio" name="clothesType" value="普通工业"> 普通工业
								</label> <label class="am-radio-inline"> <input type="radio"
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								  <label class="am-radio-inline"> <input type="radio" value="长白班"
									name="workTime"> 长白班
								</label>
								<label class="am-radio-inline"> <input type="radio" value="两班倒"
									name="workTime"> 两班倒
								</label>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<label class="am-checkbox-inline"> <input
									type="checkbox" value="单人间" name="live"> 单人间
								</label> <label class="am-checkbox-inline"> <input
									type="checkbox" name="live" value="多人间"> 多人间
								</label> <label class="am-checkbox-inline"> <input
									type="checkbox" name="docInlineRadio" value=" 卫生间"> 卫生间
								</label><br> <label class="am-checkbox-inline"> <input
									type="checkbox" name="live" value="冲凉房"> 冲凉房
								</label> <label class="am-checkbox-inline"> <input
									type="checkbox" name="live" value="热水"> 热水
								</label> <label class="am-checkbox-inline"> <input
									type="checkbox" name="live" value="空调">空调
								</label> <br><label class="am-checkbox-inline"> <input
									type="checkbox" name="live" value="厂区内">厂区内
								</label> <label class="am-checkbox-inline"> <input
									type="checkbox" name="live" value="厂区外">厂区外
								</label>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<label class="am-radio-inline"> <input type="radio" value="标准餐"
									name="eatType"> 标准餐
								</label> <label class="am-radio-inline"> <input type="radio" value="自助餐"
									name="eatType">自助餐
								</label>
								</label> <label class="am-radio-inline"> <input type="radio"
									name="eatType">不提供
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<label class="am-radio-inline"> <input
									type="radio" name="eatStandard" value="一日两餐">一日两餐
								</label> <label class="am-radio-inline"> <input
									type="radio" name="eatStandard" value="一日三餐">一日三餐
								</label> <br><label class="am-radio-inline"> <input
									type="radio" name="eatStandard"  value="一日四餐">一日四餐
								</label>
								</label> <label class="am-radio-inline"> <input
									type="radio" name="eatStandard" value="不提供">不提供
								</label>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="eatStandardEx" type="text" id="name"
									placeholder="吃饭标准补充" >
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input name="certificates" type="text" id="name" placeholder="证件要求" value="${company.name }"  >
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-4">
							    <input name="minage" type="text" class="am-form-field" placeholder="最小年龄">
							</div>
							<div class="am-u-sm-1">
								至
							</div>
							<div class="am-u-sm-4">
							    <input name="maxage" type="text" class="am-form-field" placeholder="最大年龄">
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
									<textarea name="required" class="" rows="4" id="doc-ta-1"></textarea>
							</div>
						</div>
						...
						<div class="am-form-group">
							<div class="am-u-sm-9 am-u-sm-push-3">
								<button onclick="registerCompany()" type="button"
									class="am-btn am-btn-primary am-btn-block">添加企业信息</button>
							</div>
						</div>
					</form>
				</div>
