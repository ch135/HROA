...
<body>
	...
	<div class="admin-content">
		<ol class="am-breadcrumb">
		  <li>位置：<a href="${pageContext.request.contextPath}/rbac/getRlList.html?pageSize=5&startPage=0">角色管理</a></li>
			...
			<div class="am-u-lg-5 am-u-md-15 am-u-sm-centered">
				<form class="am-form m-form-horizontal" action="#" method="post">
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8">
							<div class="am-form-group ">
								<div class="field">
									<input type="text" id="role-name" value="${roleInfo.role_name}" placeholder="角色名称" name="name">
								</div>
							</div>
						</div>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8">
							<div class="am-form-group ">
								<div class="field">
									<select name="dpId">
										<c:if test="roleInfo.dpname!=null">
											<option value="${roleInfo.deptid}">${roleInfo.dpname}</option>
										</c:if>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8">
							<div class="am-form-group">
								<textarea class="" rows="5" id="role-intro" placeholder="简单描述......">${roleInfo.role_describes}</textarea>
					            <small>100字以内...</small>
							</div>
						</div>
						<div class="am-u-sm-3"></div>
					...
					<div class="am-form-group">
						<div class="am-u-sm-9 am-u-sm-push-2">
							<input id="addRole" type="button" class="am-btn am-btn-primary" value="修改" />
						</div>
					</div>
				</form>
			</div>
...
/* 	$("#addRole").click(function(){
		$.ajax({
			...
			type:'post',
			data:{roleName:$('#deptName').val(),dpId:$('#dpId').val(),roleIntro:$('#role-intro').val()},
			dataType:'json',
