...
<body>
	...
	<div class="admin-content">
		<div class="am-cf am-padding am-padding-bottom-0">
        	<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">工作日志</strong> / <small>周计划书</small></div>
      	</div>
      	<hr>
		  	...
		  	<div class="am-u-sm-12 am-u-md-6">
			    <div class="am-btn-toolbar">
			      	<div class="am-btn-group am-btn-group-xs">
				        <button id="addWeekLog" type="button" class="am-btn am-btn-default">
...
$(document).ready(function(){
	...
	$('#addWeekLog').on('click',function(){
		window.location.href="/HROA/joblog/week/add.jsp";
	});
