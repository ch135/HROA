...
<body>
	...
	<div class="admin-content">
		<div class="am-cf am-padding am-padding-bottom-0">
        	<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">工作日志</strong> / <small>日报列表</small></div>
      	</div>
      	<hr>
			...
			<div class="am-u-sm-12">
				<table style="width:100%" class="am-table am-table-striped am-table-bordered am-table-compact am-text-nowrap" id="user-list">
					...
					<c:if test="${perPageAmount>0}">
						...
						<tr>
						  	<td>${jgLgList[i].id}</td>
						  	<td>${jgLgList[i].title}</td>
						  	<td>${jgLgList[i].addtime}</td>
						  	<td class="center"></td>
						  	...
						  	<td>
						  		<div class="am-btn-toolbar">
				                    <div class="am-btn-group am-btn-group-xs">
				                      	...
				                      	<button class="am-btn am-btn-default am-btn-xs" onclick="alertJobLogInfo('${jgLgList[i].id}')"><span class="am-icon-copy"></span>编辑</button>
...
/* 修改用户信息 */
function alertJobLogInfo(userId){
