...
<![endif]-->
  ...
  <div class="admin-content">
     <div class="am-cf am-padding">
       <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">申请中心</strong> / <small>请假申请</small></div>
     </div>
     <hr/>
	<div class="am-g">
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4 am-u-md-offset-4">
         <form class="am-form am-form-horizontal" action="/HROA/leave/addleave.html" method="post" onsubmit="return check()">
...
<a href="#" class="am-icon-btn am-icon-th-list am-show-sm-only admin-menu" data-am-offcanvas="{target: '#admin-offcanvas'}"></a>
	...
	<script src="/HROA/apply/js/leave.js"></script>
	<script>
		var result="${result}";
		if(result!=""){
			alert_(result);
