...
<![endif]-->
  ...
  <div class="admin-content">
     <div class="am-cf am-padding">
       <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">申请中心</strong> / <small>出差申请</small></div>
     </div>
     <hr/>
	<div class="am-g">
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4 am-u-md-offset-4">
         <form class="am-form am-form-horizontal" action="/HROA/trip/addtrip.html" method="post" onsubmit="return check()">
            ...
            <div class="am-form-group">
              <label for="user-QQ" class="am-u-sm-3 am-form-label">起始日期: </label>
              <div class="am-u-sm-9">
                <input type="date" id="user-start" name="start"/>
              </div>
            </div>

            <div class="am-form-group">
              <label for="user-weibo" class="am-u-sm-3 am-form-label">截至日期: </label>
              <div class="am-u-sm-9">
                <input type="date" id="user-end" name="end">
              </div>
            </div>
            
			<div class="am-form-group">
              <label for="user-weibo" class="am-u-sm-3 am-form-label">目的地: </label>
              <div class="am-u-sm-9">
                <input type="text" id="user-place" name="destination">
              </div>
            </div>
            
            <div class="am-form-group">
              <label for="user-weibo" class="am-u-sm-3 am-form-label">交通工具: </label>
              <div class="am-u-sm-9">
                <input type="text" id="user-traffic" name="traffictool">
              </div>
            </div>
            
            <div class="am-form-group">
              <label for="user-weibo" class="am-u-sm-3 am-form-label">预支费用: </label>
              <div class="am-u-sm-9">
                <input type="text" id="user-money" name="plantmoney" placeholder="单位：元"/>
              </div>
            </div>
...
<a href="#" class="am-icon-btn am-icon-th-list am-show-sm-only admin-menu" data-am-offcanvas="{target: '#admin-offcanvas'}"></a>
	...
	<script src="/HROA/apply/js/trip.js"></script>
