...
<body>
	...
	<div class="admin-content">
		<div class="am-cf am-padding am-padding-bottom-0">
        	<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">任务列表</strong> / <small>我的任务</small></div>
      	</div>
      	<hr>
		  	...
		  	<div class="am-u-sm-12 am-u-md-6">
			    <div class="am-btn-toolbar">
			      	<div class="am-btn-group am-btn-group-xs">
				        <button id="addTask" type="button" class="am-btn am-btn-default">
				...
				<table style="width:100%" class="am-table am-table-striped am-table-bordered am-table-compact am-text-nowrap" id="user-list">
					...
					<c:if test="${perPageAmount>0}">
						...
						<tr>
						  	...
						  	<td>${taskList[i].addtime}</td>
						  	<%-- <td class="center">${userList[i].deptInfo.dpname}</td>
						  	<td class="center">${userList[i].login_time}</td> --%>
						  	<td>
						  		<div class="am-btn-toolbar">
				                    <div class="am-btn-group am-btn-group-xs">
				                      	<button class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="arrangeTask('${taskList[i].dept_id}','${taskList[i].id}')"><span class="am-icon-pencil-square-o"></span>分配</button>
				                      	<button class="am-btn am-btn-default am-btn-xs" onclick=""><span class="am-icon-copy"></span>编辑</button>
...
function arrangeTask(deptId,taskId){
	window.location.href="/HROA/task/agTask.html?deptId="+deptId+"&taskId="+taskId+"&lineAmount=4";
}
...
$(document).ready(function(){
	...
	$('#addTask').on('click',function(){
		window.location.href="/HROA/task/jpTs.html";
	});
