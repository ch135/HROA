		...
		<div class="admin-content-body">
			<div class="am-cf am-padding am-padding-bottom-0">
				<div class="am-fl am-cf">
						${company!=null?company.name:'<strong class="am-text-primary am-text-lg">工作信息列表</strong> / <small>Company</small>'}
				</div>
			</div>
			<hr>
			<div class="am-g">
				<div class="am-u-sm-9 am-u-md-6" style="margin-bottom: 10px;">
					<div class="am-btn-toolbar">
						...
						<c:if test="${company!=null }">
							<button type="button" class="am-btn am-btn-default" onclick="do_add(${company.id})">
				...
				<div class="am-collapse am-topbar-collapse " id="topbar-collapse">
					<form class="am-form" action="/HROA/Jobinfo/listJobinfoUI.html" method="post">
...
<div class="am-modal am-modal-confirm" tabindex="-1" id="my-confirm">
  <div class="am-modal-dialog">
	...
	<script type="text/javascript">
		...
		function do_edit(id){
			location.href='/HROA/Jobinfo/editJobinfoUI.html?id='+id;
		}
		
		function do_show(id){
			location.href='/HROA/Jobinfo/showJobinfoUI.html?id='+id;
		}
		
		function do_add(id){
			$("form:first").attr("action","/HROA/Jobinfo/addJobinfoUI.html?cId="+id);
			$("form:first").submit();
		}
