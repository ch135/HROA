    ...
    <div class="admin-content-body">
      ...
      <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form id="doc-vld-msg" class="am-form am-form-horizontal" action="/HROA/Jobinfo/saveJobinfo.html">
          <input id="page" type="text" name="cId" value="${company.id }" style="visibility: hidden;position: absolute;">
          <input id="page" type="text" name="id" value="${jobinfo.id }" style="visibility: hidden;position: absolute;">
            ...
            <div class="am-form-group">
              <label for="user-name" class="am-u-sm-3 am-form-label">工作岗位</label>
              <div class="am-u-sm-9">
                <input name="job" type="text" id="name" placeholder="姓名 / Job" value="${jobinfo.job }" required >
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="number" type="text" id="name" placeholder="招聘人数 / number"  value="${jobinfo.number }" required >
              </div>
            </div>
            ...
            <div class="am-u-sm-9">
            	<select  id="doc-select-1" name="type" required >
            ...
            <div class="am-u-sm-9">
            	<select  id="doc-select-1" name="unit"  required>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="salary" type="text" id="name" value="${jobinfo.salary }" placeholder="基本工资 / Salary" required >
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="moreSalary" type="text" id="name"  value="${jobinfo.moreSalary }"  placeholder="加班工资 / More-Salary" required >
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="linkMan" type="text" id="name" value="${jobinfo.linkMan }" placeholder="联系人 / Link-Man" required >
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="linkPhone" type="tel" id="name" value="${jobinfo.linkPhone}" placeholder="联系人电话 / Link-Phone" required >
              </div>
            </div>
            ...
            <div class="am-u-sm-9">
            	<select  id="doc-select-1" name="classify" required>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="label" type="text" id="name" value="${jobinfo.label }" placeholder="福利 / Label" required >
              </div>
            </div>
             ...
             <div class="am-form-group am-form-inline">
              <label for="user-email" class="am-u-sm-3 am-form-label">工作地址</label>
			    ...
			    <div class="am-u-sm-12 am-u-md-4  am-u-end">
			      <select id="s_county" name="region" >
			        <option value="option1">选项一...</option>
			        <option value="option2">选项二.....</option>
			        <option value="option3">选项三........</option>
			      </select>
			...
			<div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="details" type="text" id="name" value="${jobinfo.details }" placeholder="具体地址 / details" required >
              </div>
            </div>
            
             <div class="am-form-group">
              <div class="am-u-sm-9 am-u-sm-push-3">
              <button type="button" onclick="do_edit()" class="am-btn am-btn-primary am-btn-block">确定修改</button>
              </div>
            </div>
