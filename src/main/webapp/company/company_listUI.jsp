		...
		<div class="admin-content-body">
			...
			<div class="am-g">
				<div class="am-u-sm-9 am-u-md-6" style="margin-bottom: 10px;">
					<div class="am-btn-toolbar">
						<div class="am-btn-group am-btn-group-xs">
							<button type="button" class="am-btn am-btn-default" onclick="location.href='/HROA/company/company_register.jsp'">
				...
				<div class="am-collapse am-topbar-collapse " id="topbar-collapse">
					<form class="am-form" action="/HROA/ShCompany/listCompanyUI.html" method="post">
						<div class="am-u-sm-12 am-u-md-2">
							<div class="am-form-group am-input-group-sm">
								<select name="searchType" class="am-form-field">
								<option value="name" ${searchType=='name'?'selected':'' }>企业名称</option>
						...
						<div class="am-u-sm-12 am-u-md-3">
							<div class="am-input-group am-input-group-sm">
								<input type="text" class="am-form-field" name="searchValue" value="${searchValue }"> <span class="am-input-group-btn">
									<button class="am-btn am-btn-default" type="button" onclick="searchCompany()">搜索</button>
								</span>
							</div>
						</div>
					</form>
							...
							<tbody>
								<c:forEach items="${page.list }" var="item">
									<tr>
										...
										<td class="am-hide-sm-only">${item.province }${item.city }${item.region }</td>
										<td>
											<div class="am-btn-group am-btn-group-xs">
											     <button type="button" class="am-btn am-btn-default" onclick="location.href='/HROA/ShCompany/showShCompanyUI.html?companyId=${item.id}'">
													 查看
												</button> 
												<button type="button" class="am-btn am-btn-default" onclick="location.href='/HROA/ShCompany/editShCompanyUI.html?companyId=${item.id}'">
													 编辑
												</button>
												<button type="button" class="am-btn am-btn-default" onclick="location.href='/HROA/Jobinfo/listJobinfoUI.html?cId=${item.id}'">
													招聘信息
												</button>
		...
		function deleteCompany(companyId) {
			do_confirm("确定删除?",
					function() {
						$("form:first").attr(
								"action",
								"/HROA/ShCompany/deleteShCompany.html?id="
										+ companyId);
						$("form:first").submit();
					});
		}
