...
<title>OA办公系统</title>
<meta name="description" content="这是一个 企业合同列表页面">
					...
					<div class="am-btn-toolbar">
						<div class="am-btn-group am-btn-group-xs">
							<button type="button" class="am-btn am-btn-default"
								onclick="location.href='/HROA/company/company_contract.jsp'">
								<span class="am-icon-plus"></span> 新增
							</button>
						</div>
					</div>
				</div>
				<form class="am-form" action="/HROA/ComContract/showComContractList.html" method="post" >
					<div class="am-u-sm-12 am-u-md-3">
						<div class="am-form-group">
							<select name="searchType" data-am-selected="{btnSize: 'sm'}">
								<option value="cname" ${searchType=='cname'?'selected':'' }>企业名称</option>
						...
						<div class="am-input-group am-input-group-sm">
							<input type="text" class="am-form-field" name="searchValue"
								...
								<button class="am-btn am-btn-default" type="button"
									onclick="searchComContract()">搜索</button>
							</span>
						</div>
					</div>
				</form>
											...
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
													<button type="button" class="am-btn am-btn-default am-text-success"
														onclick="location.href='/HROA/ComContract/showDetails.html?id=${comContractList.id}'">
													...
													<button type="button" class="am-btn am-btn-default am-text-danger"
														onclick="deleteComContract(${comContractList.id})">
