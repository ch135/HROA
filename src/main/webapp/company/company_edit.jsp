        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form class="am-form am-form-horizontal" action="/HROA/ShCompany/saveShCompany.html">
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="name" type="text" id="name" placeholder="姓名 / Name" value="${company.name }">
              </div>
            </div>
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">企业类别</label>
            <div class="am-u-sm-9">
              <select class="am-form-field" name="label">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="tel" name="details" id="user-phone" placeholder="详细地址 / Detail" value="${company.details }">
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="url"  type="text"   id="user-QQ" placeholder="网址/URL" value="${company.url }">
              </div>
            </div>
              ...
              <div class="am-u-sm-9">
                <input name="produce" type="text" id="produce" placeholder="主要生产产品 / Produce" value="${company.produce }">
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="linkMan" type="text" id="user-weibo" placeholder="企业联系人 / Linkman" value="${company.linkMan }">
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="linkPhone" type="text" id="user-weibo" placeholder="联系人电话 / telephone" value="${company.linkPhone }">
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                  <select name="scale" class="am-form-field">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <textarea name="describes" class="" rows="5" id="user-intro" placeholder="简介 / Intro" >${company.describes}</textarea>
                <small>250字以内...</small>
              </div>
            </div>
