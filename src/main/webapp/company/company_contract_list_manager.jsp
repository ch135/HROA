...
<title>OA办公系统</title>
<meta name="description" content="这是一个 企业合同列表页面（经理）">
	...
	<div class="admin-content">
		<div class="admin-content-body">
			...
			<div class="am-g">
				...
				<form class="am-form" action="/HROA/ComContract/showComContractListToManager.html" method="post" >
											...
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
													<button type="button" class="am-btn am-btn-default am-text-success"
														onclick="location.href='/HROA/ComContract/showComDetailsToManager.html?id=${comContractList.id}'">
