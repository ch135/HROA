	...
	<div class="admin-content">
		<div class="admin-content-body">
			...
			<div class="am-g">
				...
				<form class="am-form" action="/HROA/AgentContract/showAgentContractListToManager.html"
					method="post">
											...
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
													<button type="button" class="am-btn am-btn-default am-text-success"
														onclick="location.href='/HROA/AgentContract/showAgentDetailsToManager.html?id=${agentList.id}'">
