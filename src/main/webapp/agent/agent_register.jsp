    ...
    <div class="admin-content-body">
      ...
      <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form id="doc-vld-msg" class="am-form am-form-horizontal" action="/HROA/Agent/addAgent.html">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
            	<select  id="doc-select-1" name="identity" required>
					<option value="学生"  ${searchType=='name'?'selected':'' }>学生</option>
					<option value="社会工作人员" ${searchType=='linkMan'?'selected':'' }>社会工作人员</option>
				</select>
            </div>
          </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="idcardNum"  type="text"   id="idcard" placeholder="身份证 / IdCard" required>
              </div>
            </div>
            ...
            <hr>
              ...
              <div class="am-u-sm-9">
                <input name="manager" type="text" id="transport" placeholder="负责人 / Transport" required>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="managerTel" type="text" id="telephone" placeholder="负责人电话 / Telephone" required>
              </div>
            </div>

            <div class="am-form-group">
              <div class="am-u-sm-9 am-u-sm-push-3">
              <button type="button" onclick="registerUser()" class="am-btn am-btn-primary am-btn-block">确定添加</button>
              </div>
            </div>
