...
<title>OA办公系统</title>
<meta name="description" content="这是一个 给代理查看代理合同页面">
		...
		<div class="admin-content-body">
			...
			<div class="am-g">
				...
				<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
					<form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/AgentContract/edit.html" Method="post" enctype="multipart/form-data">
