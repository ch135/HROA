...
<title>OA办公系统</title>
<meta name="description" content="这是一个 给代理看的合同页面">
...
<![endif]-->
	...
	<div class="admin-content">
		<div class="admin-content-body">
			...
			<div class="am-g">
				<form class="am-form" action="/HROA/AgentContract/showAgentContractListToAgent.html"
					method="post">
											...
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
													<button type="button" class="am-btn am-btn-default am-text-success"
														onclick="location.href='/HROA/AgentContract/showAgentDetails.html?id=${agentList.id}'">
