    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">工资明细</strong> / <small>Salary Details</small></div>
            </div>
            <div class="am-g">
                ...
                <div class="am-u-sm-10 am-u-md-3" style="float: right;">
                    <div class="am-input-group am-input-group-sm">
                        <input type="text" class="am-form-field" id="content" placeholder="输入工号">
                        <span class="am-input-group-btn">
                ...
                <div class="am-u-sm-12">
                    <table class="am-table am-table-striped am-table-striped">
                        ...
                        <tr>
                            ...
                            <th>工号</th>
                            <th>名字</th>
                            <th class="am-hide-sm-only">应得工资</th>
                            <th class="am-hide-sm-only">总工资</th>
                            <th class="am-hide-sm-only">总扣款</th>
                        ...
                        <c:forEach items="${list}" var="list">
                            <tr>
                                ...
                                <td>${list.number}</td>
                                <td>${list.name}</td>
                                <td class="am-hide-sm-only">${list.deserved}</td>
                                <td class="am-hide-sm-only">${list.salary}</td>
                                <td class="am-hide-sm-only">${list.allcost}</td>
                                <td class="am-hide-sm-only">${list.salaryDate}</td>
                                <td>${list.realwages}</td>
                                <td>
                                    <div class="am-btn-toolbar" id="edit">
                                        <div class="am-btn-group am-btn-group-xs">
                                            ...
                                            <a href="/HROA/detail/update.html?id=${list.id}">
        ...
        <div class="am-modal am-modal-confirm" tabindex="-1" id="import">
            <div class="am-modal-dialog">
                <form action="/HROA/detail/import.html" id="importInfo" onsubmit="return checkData()" method="post" enctype="multipart/form-data">
...
<script src="${pageContext.request.contextPath}/js/salary/detail.js"></script>
<script>
    $("#page").page({
        pages:${allPage},
        curr:${currentPage},
