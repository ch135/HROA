		...
		<div class="admin-content-body">
			<div class="am-cf am-padding am-padding-bottom-0">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">离职记录</strong> / <small>Record</small>
				</div>
			</div>
			<hr>
			<div class="am-g">
					...
					<tbody>
						<c:forEach items="${page.list }" var="item">
							<tr>
								...
								<td>
									<div class="am-btn-group am-btn-group-xs">
										<button type="button" class="am-btn am-btn-default" onclick="location.href='/HROA/EnterCom/showEnterComUI.html?leave=leave&enterComid=${item.enterComid}'">查看</button>
										<button type="button" class="am-btn am-btn-default" onclick="location.href='/HROA/EnterCom/editEnterComUI.html?leave=leave&enterComid=${item.enterComid}'">编辑</button>
      ...
      <div class="am-g">
        <div class="am-u-sm-12 am-u-md-12">
          <form id="doc-vld-msg" class="am-form am-form-horizontal" action="/HROA/EnterCom/listEnterComUI.html" method="post">
          	...
          	<input id="leave" type="text" name="leave" value="leave" style="visibility: hidden;position: absolute;">
            ...
            <div class="am-form-group">
			 ...
			 <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <select name="leaveDate" class="am-form-field" disabled="disabled">
					<option value="" >不限</option>
					<option value="在职" ${enterCom.leaveDate=='在职'?'selected':'' }>在职</option>
					<option value="离职" ${enterCom.leaveDate=='离职'?'selected':'' }>离职</option>
				</select>
              </div>
            </div>
		...
		<div class="am-modal-dialog">
			...
			<div class="am-modal-bd">
				<div class="am-form-group am-input-group-sm am-form-icon">
					<i class="am-icon-calendar"></i> <input type="text" value="" name="date" class="am-form-field" data-am-datepicker="{format: 'yyyy-mm-dd'}" placeholder="日历组件"  data-am-datepicker readonly />
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		function confirm_date(id) {
			...
			$('#my-prompt').modal({relatedElement : this,onConfirm : function(data) {
					...
					var url="/HROA/EnterCom/confirmEnterCom.html?id="+ id+"&date="+time1;
