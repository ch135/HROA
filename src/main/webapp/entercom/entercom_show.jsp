  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">入职记录</strong> / <small>Personal information</small></div>
      </div>
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          ...
          <div class="am-form-group">
            ...
            <hr>
              ...
              <div class="am-u-sm-9">
                <input name="sendUnit" type="text" id="transport" value="${enterCom.sendUnit}"  placeholder="输送单位 / Transport" required disabled>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="sendTelephone" type="text" id="telephone" value="${enterCom.sendTelephone}"  placeholder="输送联系人电话 / Telephone" required disabled>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="sendCompany" type="text" id="company" value="${enterCom.sendCompany}"  placeholder="所进企业 / Company" required disabled>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="workerId" type="text" id="company" value="${enterCom.workerId}" placeholder="驻厂管理 / Manager" required disabled>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="managerTel" type="text" id="company" value="${enterCom.managerTel}"  placeholder="驻厂管理 / Manager" required disabled>
              </div>
            </div>
             ...
             <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="managerTel1" type="text" id="company" value="${enterCom.isWork==true?'在职':'离职'}"  placeholder="状态 / Status" required disabled>
              </div>
            </div>
             ...
             <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="leaveDate" type="text" id="company" value="${enterCom.leaveDate }" placeholder="离职时间 / LeaveDate" data-am-datepicker="{format: 'yyyy-mm-dd'}"  data-am-datepicker readonly  required disabled />
              </div>
            </div>
             ...
             <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input name="leaveReason" type="text" id="company" value="${enterCom.leaveReason }" placeholder="离职原因 / LeaveReason" required disabled />
              </div>
            </div>
